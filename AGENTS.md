...
기준 숏폼 영상 하나를 정하고, 그 영상을 **후킹·구성·카피·편집** 항목별로 분석하는 **분석 프롬프트**를 저장·복사해 쓰는 아카이브. 화면은 프레임워크 없이 바닐라 HTML/CSS/JS로 동작하며, **모든 데이터는 [`templates.json`](templates.json) 한 파일**에 있습니다.
